...
`;
    ...
    console.log(
      `Sending event firstPart: conn.write(msg) result=${conn.write(firstPart)}`,
    );
    console.log(
      `Sending event secondPart: conn.write(msg) result=${conn.write(secondPart)}`,
    );
  });
});
server.listen(9000);
